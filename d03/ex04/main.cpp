...
//   Updated: 2015/01/08 23:40:08 by nfruneau         ###   ########.fr       //
//                                                                            //
// ************************************************************************** //
...
int		main() {
	...
	std::cout << "/******************** FR4G-TP ********************\\" << std::endl << std::endl << "---> Create 2 FragTrap (named and copy):" << std::endl;
	...
	std::cout << std::endl << "/******************** SC4V-TP ********************\\" << std::endl << std::endl << "---> Create 2 ScavTrap (named and copy):" << std::endl;
	...
	std::cout << std::endl << "/******************** SUPER-TP ********************\\" << std::endl << std::endl << "---> Create 2 NinjaTrap:" << std::endl;
	SuperTrap	robot7("Clark");
	SuperTrap	robot8("Lex");

	std::cout << std::endl << "---> Use basic attacks:" << std::endl;
	robot7.rangedAttack("Dave");
	robot7.meleeAttack("Dave");

	std::cout << std::endl << "---> Use ninjaShoebox on different target:" << std::endl;
	robot7.ninjaShoebox(robot1);
	robot7.ninjaShoebox(robot3);
	robot7.ninjaShoebox(robot6);

	std::cout << std::endl << "---> Use random special attacks:" << std::endl;
	robot8.vaulthunter_dot_exe("Steven");
	robot8.vaulthunter_dot_exe("Steven");
	robot8.vaulthunter_dot_exe("Steven");
	robot8.vaulthunter_dot_exe("Steven");
	robot8.vaulthunter_dot_exe("Steven");
